      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className={`${cardBackgroundClass} shadow rounded-lg p-6`}>
          ...
          <form onSubmit={handleDistributeTickets} className="space-y-6">
            <div>
              <label htmlFor="grossiste" className={`block text-sm font-medium ${textClass} mb-2`}>
              ...
              <select id="grossiste" value={selectedGrossiste} onChange={(e) => setSelectedGrossiste(e.target.value)}
                ...
                required >
                <option value="" className={`${textClass}`}>-- Choisir un grossiste --</option>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className={`${textClass} ${background3Class} px-6 py-3 text-left text-xs font-medium uppercase tracking-wider`}>Grossiste</th>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className={`${cardBackgroundClass} shadow rounded-lg p-6`}>
          ...
          <form onSubmit={handleDistributeTicketsVip} className="space-y-6">
            <div>
              <label htmlFor="grossisteVip" className={`block text-sm font-medium ${textClass} mb-2`}>
                Sélectionner un grossiste
              </label>
