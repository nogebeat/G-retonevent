...
export default function GrossisteProfile() {
      ...
      <div className="flex flex-1">
        ...
        <Sidebar 
          ...
          links={[
            ...
            { label: 'Distribution', href: '/grossiste/distributions', icon: 'share' },
          ...
          <div className={`${cardBackgroundClass} shadow-lg rounded-xl overflow-hidden mb-8`}>
            ...
            <div className="px-6 py-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                {parentInfo && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500">Mon Super Grossiste</p>
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  onClick={openEditModal} // Utiliser la nouvelle fonction
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            <button
              ...
              className="px-4 py-2 text-gray-900 bg-gray-200 rounded-md hover:bg-gray-300 transition-colors"
            >
              Annuler
            </button>
            <button
        ...
        <form onSubmit={handlePasswordChange} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              name="new_password"
              required
              className="w-full px-3 py-2 border text-gray-900 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
