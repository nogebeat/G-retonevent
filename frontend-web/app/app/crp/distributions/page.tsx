...
//   const [activeTab, setActiveTab] = useState(searchParams.get('tab') === 'vip' ? 'vip' : 'standard');
  

//   // États pour Standard
//   const [grossistes, setGrossistes] = useState<any[]>([]);
//   const [selectedGrossiste, setSelectedGrossiste] = useState<string>('');
...
//   // États pour VIP
//   const [grossistesVip, setGrossistesVip] = useState<any[]>([]);
//   const [selectedGrossisteVip, setSelectedGrossisteVip] = useState<string>('');
...
//         if (data.user && data.user.role_id !== 2) { // Role ID 2 corresponds to crp
//           router.push('/');
//           return;
//         }
...
//       const processedGrossistes = grossistesData.map((grossiste: any) => ({
//         ...grossiste,
//         est_actif: grossiste.est_actif === 1 || grossiste.est_actif === true
//       }));
...
//     if (!selectedGrossisteVip) {
//       setErrorVip('Veuillez sélectionner un grossiste');
//       return;
//     }
...
//           <h2 className="text-xl font-semibold text-gray-800 mb-6">Distribuer des tickets Standard</h2>
...
//             <div>
//               <label htmlFor="grossiste" className="block text-sm font-medium text-gray-600 mb-2">
//                 Sélectionner un grossiste
//               </label>
//               <select id="grossiste" value={selectedGrossiste} onChange={(e) => setSelectedGrossiste(e.target.value)}
//                 className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-gray-600"
//                 required >
//                 <option value="" className='text-gray-600'>-- Choisir un grossiste --</option>
//                 {grossistes.filter(r => r.est_actif).map((grossiste) => (
//                   <option className='text-gray-600' key={grossiste.id} value={grossiste.id}>
//                     {grossiste.nom} {grossiste.prenoms} ({grossiste.telephone}) </option>))}
//               </select>
//             </div>
...
//                 <input id="quantity" type="number" value={ticketQuantity} onChange={(e) => setTicketQuantity(parseInt(e.target.value) || 0)}
//                   className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-gray-600"
//                   required/>
//               </div>
//               <p className="mt-2 text-sm text-gray-600"> {availableTickets} ticket(s) standard disponible(s) pour distribution </p>
//             </div>
            
//             <div className="pt-4">
//               <button
//                 type="submit"
//                 disabled={submitting || ticketQuantity > availableTickets || !selectedGrossiste}
...
//         <div className="bg-white shadow rounded-lg p-6">
//           <h2 className="text-xl font-semibold text-gray-800 mb-6">Informations Standard</h2>
...
//                 </div>
//                 <div className="ml-4">
//                   <h3 className="text-lg font-medium text-green-800">Grossistes actifs</h3>
//                   <p className="text-green-700">{grossistes.filter(r => r.est_actif).length} grossiste(s)</p>
//                 </div>
//               </div>
//             </div>
...
//         <h2 className="text-xl font-semibold text-gray-800 mb-6">Historique des distributions Standard</h2>
...
//                   <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Grossiste</th>
//                   <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nombre de tickets</th></tr>
//               </thead>
...
//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
//         <div className="bg-white shadow rounded-lg p-6">
//           <h2 className="text-xl font-semibold text-gray-800 mb-6">Distribuer des tickets VIP</h2>
...
//             <div>
//               <label htmlFor="grossisteVip" className="block text-sm font-medium text-gray-600 mb-2">
//                 Sélectionner un grossiste
//               </label>
//               <select id="grossisteVip" value={selectedGrossisteVip} onChange={(e) => setSelectedGrossisteVip(e.target.value)}
...
//                 required >
//                 <option value="" className='text-gray-600'>-- Choisir un grossiste --</option>
//                 {grossistesVip.filter(r => r.est_actif).map((grossiste) => (
//                   <option className='text-gray-600' key={grossiste.id} value={grossiste.id}>
//                     {grossiste.nom} {grossiste.prenoms} ({grossiste.telephone}) </option>))}
//               </select>
//             </div>
...
//             <div>
//               <label htmlFor="quantityVip" className="block text-sm font-medium text-gray-600 mb-2">
...
//                   required/>
//               </div>
//               <p className="mt-2 text-sm text-gray-600"> {availableTicketsVip} ticket(s) VIP disponible(s) pour distribution </p>
//             </div>
            
//             <div className="pt-4">
//               <button
//                 type="submit"
//                 disabled={submittingVip || ticketQuantityVip > availableTicketsVip || !selectedGrossisteVip}
...
//         <div className="bg-white shadow rounded-lg p-6">
//           <h2 className="text-xl font-semibold text-gray-800 mb-6">Informations VIP</h2>
...
//                 </div>
//                 <div className="ml-4">
//                   <h3 className="text-lg font-medium text-orange-800">Grossistes VIP actifs</h3>
//                   <p className="text-orange-700">{grossistesVip.filter(r => r.est_actif).length} grossiste(s)</p>
//                 </div>
//               </div>
//             </div>
...
//       <div className="bg-white shadow rounded-lg p-6 mt-6">
//         <h2 className="text-xl font-semibold text-gray-800 mb-6">Historique des distributions VIP</h2>
...
//           {error && (
//             <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4 sm:mb-6">
//               {error}
//             </div>
//           )}
