...
//             <div>
//               <label htmlFor="revendeur" className="block text-sm font-medium text-gray-600 mb-2">
...
//                 required >
//                 <option value="" className='text-gray-600'>-- Choisir un revendeur --</option>
...
//                   <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Revendeur</th>
...
//             <div>
//               <label htmlFor="revendeurVip" className="block text-sm font-medium text-gray-600 mb-2">
//                 Sélectionner un revendeur
//               </label>
